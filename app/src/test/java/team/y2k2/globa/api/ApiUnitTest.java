...
public class ApiUnitTest {
    ...
    private final String accessToken = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiI5IiwiZXhwIjoxNzQxNDUwNjY5fQ.6KG6zSTsu04Yf4Vt3XvUjz1n_OsUTpBxZ5C_7JniOLM";
    ...
    public void getUser() {
        ...
        assertThat("주소가 http로 시작해야 합니다.", response.getProfile().startsWith("http"));
