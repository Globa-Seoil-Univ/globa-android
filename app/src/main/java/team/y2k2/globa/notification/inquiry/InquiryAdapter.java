...
import team.y2k2.globa.notification.NotificationModel;
...
public class InquiryAdapter extends RecyclerView.Adapter<InquiryAdapter.AdapterViewHolder> {
    ...
    public InquiryAdapter(NotificationModel items) {
        this.items = items;
    }
    ...
    public InquiryAdapter.AdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (type) {
            case TYPE_NOTIFICATION:
                ...
                return new InquiryAdapter.AdapterViewHolder(view, TYPE_NOTIFICATION);
            ...
            case TYPE_SHARED_FOLDER_ADD_USER:
                ...
                return new InquiryAdapter.AdapterViewHolder(view, TYPE_SHARED_FOLDER_ADD_USER);
            ...
            case TYPE_UPLOAD_SUCCESS:
                ...
                return new InquiryAdapter.AdapterViewHolder(view, TYPE_UPLOAD_SUCCESS);
            case TYPE_UPLOAD_FAILED:
                break;

            case TYPE_INQUIRY_ANSWERED:
                view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_notification_inquiry, parent, false);
                return new InquiryAdapter.AdapterViewHolder(view, TYPE_INQUIRY_ANSWERED);
        }
...
//                holder.inquiryTitle.setText("이 외 형식입니다.");
            ...
            case TYPE_INQUIRY_ANSWERED:
                holder.inquiryTitle.setText(items.getNotifications().get(position).getInquiry().getTitle());
